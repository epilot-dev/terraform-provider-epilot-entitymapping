...
type OperationObjectNode struct {
	...
	Random *RandomOperation `json:"_random,omitempty"`
	Set    any              `json:"_set,omitempty"`
	// Define handlebars template to output a string
	Template *string `json:"_template,omitempty"`
	// Unique array
...
func (o *OperationObjectNode) GetRandom() *RandomOperation {
	if o == nil {
		return nil
	}
	return o.Random
...
func (o *OperationObjectNode) GetTemplate() *string {
	if o == nil {
		return nil
	}
	return o.Template
